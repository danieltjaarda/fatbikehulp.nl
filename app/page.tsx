                ...
                <div className="mt-4 flex flex-col gap-3 items-start">
                  <div className="flex items-center gap-3">
                    <a 
                      ...
                      className="text-white px-6 py-3 rounded-full font-semibold transition-colors bg-[#456882] hover:bg-[#3a5a6f] inline-flex items-center gap-2"
                    >
      ...
      <section className="bg-white py-4 sm:py-6">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
            ...
            <Link href="/aanvraag" className="bg-brand-light rounded-2xl p-6 sm:p-8 relative overflow-hidden hover:shadow-lg transition-all cursor-pointer block">
              <div className="relative z-10">
                ...
                <button className="bg-brand-dark hover:bg-[#014d47] text-white px-6 py-3 sm:px-8 sm:py-4 rounded-full font-semibold text-base sm:text-lg transition-all shadow-md hover:shadow-lg flex items-center justify-center gap-2 group">
            ...
            <a 
              ...
              onClick={trackCallConversion}
              className="bg-white rounded-2xl relative overflow-hidden border-2 border-black hover:border-brand-medium transition-colors cursor-pointer block"
            >
              <div className="relative z-10 p-6 sm:p-8">
                ...
                <div className="w-12 h-12 bg-brand-medium rounded-full flex items-center justify-center hover:bg-brand-dark transition-colors">
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="md:hidden mt-6 flex gap-4">
            <a
              ...
              rel="noopener noreferrer"
              onClick={trackCallConversion}
              className="flex-1 bg-white border-2 border-[#456882] hover:bg-gray-50 text-[#456882] px-6 py-4 rounded-full font-semibold text-center transition-colors flex items-center justify-center gap-2"
            >
            ...
            <a
              href="tel:31850604213"
              onClick={trackCallConversion}
              className="flex-1 bg-[#456882] hover:bg-[#3a5a6f] text-white px-6 py-4 rounded-full font-semibold text-center transition-colors flex items-center justify-center gap-2"
            >
