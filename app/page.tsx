                ...
                <div className="mt-4 flex flex-col gap-3 items-start">
                  <div className="flex items-center gap-3">
                    <a 
                      ...
                      className="text-white px-6 py-3 rounded-full font-semibold transition-colors bg-[#B22D23] hover:bg-[#8f241c] inline-flex items-center gap-2"
                    >
      ...
      <section className="bg-white py-4 sm:py-6">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
            ...
            <Link href="/aanvraag" className="rounded-2xl p-6 sm:p-8 relative overflow-hidden hover:shadow-lg transition-all cursor-pointer block" style={{ backgroundColor: '#FFAEA8' }}>
            ...
            <a 
              ...
              onClick={trackCallConversion}
              className="bg-white rounded-2xl relative overflow-hidden border-2 border-black hover:border-[#B22D23] transition-colors cursor-pointer block"
            >
              <div className="relative z-10 p-6 sm:p-8">
                ...
                <div className="w-12 h-12 bg-[#25D366] rounded-full flex items-center justify-center hover:bg-[#B22D23] transition-colors">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
            ...
            <div className="relative rounded-2xl border border-gray-200 aspect-square overflow-hidden">
              ...
              <div className="absolute inset-0 bg-black/30 flex flex-col p-6 sm:p-8">
                ...
                <Link href="/aanvraag">
                  <button className="bg-red-500 text-white px-4 py-2 rounded-full font-semibold hover:bg-red-600 transition-colors mt-auto w-fit">
                    Aanvragen
                  </button>
                </Link>
              </div>
