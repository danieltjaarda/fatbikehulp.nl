...
export default function ProductDetailPage() {
  ...
  return (
    <div className="min-h-screen bg-white">
      {/* Slide-down notification for added to cart */}
      <div 
        ...
        <div className="bg-green-500 text-white py-4 px-6 shadow-lg">
          <div className="max-w-7xl mx-auto flex items-center justify-center gap-3">
            ...
            <span className="font-medium">
              {addedProductName ? `"${addedProductName}" toegevoegd aan winkelwagen` : 'Toegevoegd aan winkelwagen'}
            </span>
          </div>
        </div>
      </div>
            ...
            <div className="flex flex-col">
              ...
              <div className="space-y-2 mb-6">
                <div className="flex items-center gap-2 text-sm text-gray-900">
                  ...
                  <span>Geschikt voor alle fatbike modellen</span>
                </div>
                <div className="flex items-center gap-2 text-sm text-gray-900">
                  <svg className="w-4 h-4 flex-shrink-0" style={{ color: '#008500' }} fill="none" stroke="currentColor" viewBox="0 0 24 24">
                    <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={3} d="M5 13l4 4L19 7" />
              ...
              <div className="mt-8 relative overflow-visible">
                ...
                />
                <div className="bg-[#234C6A] rounded-3xl p-4 flex items-center gap-4 relative">
                  ...
                  <a href="tel:+31850604213">
                    <button className="bg-white text-[#234C6A] px-4 py-2 rounded-lg font-semibold text-sm hover:bg-gray-100 transition-colors flex items-center gap-2">
