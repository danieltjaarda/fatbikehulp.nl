...
<main>
        <article className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
          ...
          <div className="mb-6">
            ...
            <span className="ml-4 text-sm text-gray-500">15 januari 2025 • 5 min lezen</span>
          </div>
          ...
          <div className="prose prose-lg max-w-none mb-8">
            <p className="text-xl text-gray-700 leading-relaxed mb-6">
              Een fatbike is een investering die u jarenlang plezier kan geven, mits u deze goed onderhoudt. 
              Regelmatig onderhoud verlengt niet alleen de levensduur van uw fiets, maar zorgt ook voor betere 
              prestaties en veiligheid. In deze gids leggen we uit hoe u uw fatbike in topconditie houdt.
            </p>
            ...
            <p className="text-gray-700 mb-4">
              Na elke rit is het belangrijk om uw fatbike even te controleren. Controleer de bandenspanning, 
              maak de fiets schoon en controleer op losse onderdelen. Dit kost maar een paar minuten maar kan 
            ...
            <p className="text-gray-700 mb-4">
              Elke week moet u de ketting smeren, de remmen controleren en de batterij status checken. 
              Zorg dat alle bouten goed vast zitten en controleer de remblokken op slijtage.
            </p>
            ...
            <p className="text-gray-700 mb-4">
              Maandelijks is het tijd voor een grondigere controle. Controleer de remvloeistof, inspecteer 
              de kabels en zorg dat alle bewegende delen goed gesmeerd zijn. Controleer ook de spaken en 
              de velgen op beschadigingen.
            </p>
            ...
            <p className="text-gray-700 mb-4">
              Naast uw eigen onderhoud is het belangrijk om minimaal één keer per jaar professioneel onderhoud 
              te laten uitvoeren. Onze ervaren technici kunnen een complete beurt uitvoeren waarbij alle 
              onderdelen worden gecontroleerd, gesmeerd en waar nodig vervangen.
            </p>
            <p className="text-gray-700 mb-6">
              <Link href="/aanvraag" className="text-brand-dark hover:text-brand-medium underline font-semibold">
                Plan nu uw onderhoud
              </Link> en laat onze technici uw fatbike in topconditie brengen. Wij komen naar u toe, 
          ...
          <div className="bg-brand-light rounded-2xl p-6 mt-8">
            ...
            <p className="text-gray-700 mb-4">
              Onze technici staan klaar om u te helpen. Plan eenvoudig een onderhoudsbeurt via ons 
              online formulier.
            </p>
            <Link href="/aanvraag">
          ...
          <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
            <div className="prose prose-lg max-w-none">
              ...
              <div className="text-gray-700 space-y-4 text-lg leading-relaxed">
                <p>
                  Hoewel u veel onderhoud zelf kunt doen, is het belangrijk om regelmatig professioneel onderhoud te laten uitvoeren. 
                  Onze ervaren technici hebben toegang tot gespecialiseerde gereedschappen en diagnostische apparatuur die nodig zijn 
                  voor een grondige inspectie en onderhoud van uw fatbike.
                </p>
                <p>
                  Tijdens een professionele onderhoudsbeurt controleren we niet alleen de mechanische onderdelen, maar ook de 
                  elektrische systemen, batterijgezondheid en alle veiligheidsaspecten. We geven u altijd een duidelijk overzicht 
                  van wat we hebben gecontroleerd en wat eventueel aandacht nodig heeft. Op alle uitgevoerde werkzaamheden geven 
                  wij 3 maanden garantie.
                </p>
                <p>
                  Plan eenvoudig een onderhoudsbeurt via ons <Link href="/aanvraag" className="text-brand-dark hover:text-brand-medium underline font-semibold">online formulier</Link> of 
