...
<main>
        <article className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
          ...
          <div className="mb-6">
            ...
            <span className="ml-4 text-sm text-gray-500">5 januari 2025 • 4 min lezen</span>
          </div>

          <h1 className="text-4xl sm:text-5xl font-bold mb-6" style={{ color: '#323232' }}>
            Wanneer moet je je fatbike laten onderhouden?
          </h1>

          <div className="prose prose-lg max-w-none mb-8">
            <p className="text-xl text-gray-700 leading-relaxed mb-6">
              Regelmatig onderhoud is essentieel voor de levensduur en prestaties van uw fatbike. 
              Maar wanneer is het precies tijd voor onderhoud? In dit artikel leggen we uit welke 
              signalen u niet moet negeren en hoe vaak u onderhoud nodig heeft.
            </p>
            ...
            <ul className="list-disc list-inside text-gray-700 mb-4 space-y-2">
              <li>Verminderde actieradius van de batterij</li>
              <li>Ongewone geluiden tijdens het rijden</li>
              <li>Remmen die niet optimaal werken</li>
              <li>Losse of versleten onderdelen</li>
              <li>Ketting die niet soepel loopt</li>
              <li>Bandenspanning die snel daalt</li>
            </ul>
            ...
            <p className="text-gray-700 mb-4">
              Wij adviseren om minimaal één keer per jaar een complete onderhoudsbeurt te laten uitvoeren. 
              Voor intensief gebruik (dagelijks of meerdere keren per week) is het verstandig om dit 
            ...
            <p className="text-gray-700 mb-4">
              Het is ook verstandig om uw fatbike te laten onderhouden bij seizoenswisselingen. 
              Voor de winter is het belangrijk om de fiets winterklaar te maken, en voor de zomer 
              kunt u een zomerbeurt laten uitvoeren om optimaal te genieten van het mooie weer.
            </p>

            <h2 className="text-2xl sm:text-3xl font-bold mb-4 mt-8" style={{ color: '#323232' }}>
              Onze onderhoudspakketten
            </h2>
            <p className="text-gray-700 mb-4">
              Wij bieden verschillende onderhoudspakketten aan, van basic tot deluxe. Bekijk onze{' '}
              <Link href="/tarieven" className="text-brand-dark hover:text-brand-medium underline font-semibold">
                tarieven pagina
              </Link> voor meer informatie over wat er in elk pakket zit.
            </p>
            ...
            <p className="text-gray-700 mb-4">
              Wacht niet tot er problemen ontstaan. Regelmatig onderhoud voorkomt dure reparaties 
              en zorgt ervoor dat uw fatbike altijd optimaal presteert.
            </p>
            <p className="text-gray-700 mb-6">
              <Link href="/aanvraag" className="text-brand-dark hover:text-brand-medium underline font-semibold">
                Plan nu uw onderhoud
              </Link> en wij komen binnen 3 dagen naar u toe, waar u ook bent in Nederland.
            </p>
          </div>
          ...
          <div className="bg-brand-light rounded-2xl p-6 mt-8">
            ...
            <p className="text-gray-700 mb-4">
              Plan eenvoudig een onderhoudsbeurt via ons online formulier. Onze technici komen naar u toe.
            </p>
            <Link href="/aanvraag">
          ...
          <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
            <div className="prose prose-lg max-w-none">
              <h2 className="text-2xl sm:text-3xl font-bold mb-4" style={{ color: '#323232' }}>
                Plan uw onderhoudsbeurt eenvoudig online
              </h2>
              <div className="text-gray-700 space-y-4 text-lg leading-relaxed">
                <p>
                  Wanneer u merkt dat het tijd is voor onderhoud, kunt u eenvoudig een afspraak plannen via ons online formulier. 
                  Onze service is beschikbaar door heel Nederland - wij komen naar u toe met alle benodigde gereedschappen en onderdelen.
                </p>
                <p>
                  Tijdens een onderhoudsbeurt controleren onze technici alle kritieke onderdelen van uw fatbike. We geven u altijd 
                  een duidelijk overzicht van wat we hebben gecontroleerd en wat eventueel aandacht nodig heeft. Op alle uitgevoerde 
                  werkzaamheden geven wij 3 maanden garantie.
                </p>
                <p>
                  Bekijk onze <Link href="/tarieven" className="text-brand-dark hover:text-brand-medium underline font-semibold">onderhoudspakketten</Link> en 
                  plan eenvoudig een afspraak via ons <Link href="/aanvraag" className="text-brand-dark hover:text-brand-medium underline font-semibold">online formulier</Link>. 
                  Binnen 3 werkdagen staan wij op uw stoep voor professioneel fatbike onderhoud.
                </p>
              </div>
            </div>
          </div>
